...
class NotificationsManager extends StatelessWidget {
  ...
  final List<String> _notifications_date = ['01 Dec.','25 Nov.','15 Nov.','01 Nov.','23 Oct.','01 Oct.','09 Sep.','02 Sep.'];
  final List<String> _notifications_details = ['The last month you used 15,663l of water. The consumption limit was set at 13,000l.','You just used 100% of your consumption, that is currently set at 13,000. Be careful!','You just reached 80% of your consumption limit, that is currently set at 13,000.','Good job! Last month you used less than your consumption limit. Keep up the good work!','You just reached 80% of your consumption limit, that is currently set at 13,000.','Good job! Last month you used less than your consumption limit. Keep up the good work!','ALERT! There is a suspicion of water leakage with the Kitchen Sink!','You successfully set the monthly consumption limit to 13,000l (previous was 15,000l)'];
