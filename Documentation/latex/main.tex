...
\begin{enumerate}
  ...
  \begin{center}
    \includegraphics[max width=4cm]{pages/signup.jpg}
  \end{center}
  ...
  \begin{center}
    \includegraphics[max width=4cm]{pages/houseregistration.jpg}
  \end{center}
  ...
  \begin{center}
    \includegraphics[max width=4cm]{pages/historyandprojection.jpg}
  \end{center}
  ...
  \begin{center}
    \includegraphics[max width=4cm]{pages/holidaymode.jpg}
  \end{center}
  ...
  \begin{center}
    \includegraphics[max width=4cm]{pages/notifications.jpg}
  \end{center}
  ...
  \begin{center}
    \includegraphics[max width=4cm]{pages/profilesettings.jpg}
  \end{center}
...
\begin{enumerate}
  ...
  This mobile application internaly calls the required back end services. These services are comprised of the authentication service as well as a service that manages the data produced by the smart appliances.
...
The best way of acheiving this is to look back at what went well, and more importantly what went wrong. Learning from mistakes made in the past is the fastest way to improve.\\
